...
class AppNavigator {
  ...
  static void startLogin() {
    Get.offNamedUntil(AppRoutes.login, (route) => route.settings.name == AppRoutes.login);
  }
  ...
  static startUserProfilePane({
    ...
    return offAndToNamed
        ? Get.offAndToNamed(AppRoutes.userProfilePanel, arguments: arguments)?.whenComplete(() {
