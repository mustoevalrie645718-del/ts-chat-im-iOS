...
import 'package:openim/pages/splash/kkxpricy_page.dart';
import 'package:openim_common/openim_common.dart';

import '../../../account_deletion_page.dart';
import 'account_setup_logic.dart';

class AccountSetupIngPage extends StatelessWidget {
  final logic = Get.find<AccountSetupLogic>();

  AccountSetupIngPage({super.key});
