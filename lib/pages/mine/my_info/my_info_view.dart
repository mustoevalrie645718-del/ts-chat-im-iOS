...
class YouMyInfoPage extends StatelessWidget {
  final logic = Get.find<MyInfoLogic>();
  final imLogic = Get.find<IMController>();

  YouMyInfoPage({super.key});
  ...
  Widget _buildCornerBgViews({required List<Widget> children}) => Container(
