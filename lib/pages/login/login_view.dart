...
import '../splash/kkxpricy_page.dart';
import 'login_logic.dart';

class MyLoginPage extends GetView<LoginLogic> {
  ...
  /// Build page layout
  Widget _buildqLayout() {
    return LayoutBuilder(
      builder: (context, constraints) {
        return Container(
          decoration: BoxDecoration(
            image: const DecorationImage(
              image:AssetImage(ImageRes.bg_login,package: 'openim_common'),
  ...
  Widget _buildeLogo() {
    return Row(
      ...
      children: [
        ...
        10.horizontalSpace,
        StrRes.welcome.toText..style = Styles.ts_0089FF_22sp_semibold,
      ],
    );
  }

  /// Build login form
  Widget _buildrLoginForm() {
    return Padding(
  ...
  // buildPricyView(context) {
  //   return Row(
  //     children: [
  //       Checkbox(
  //           value: logic.hadRead.value, onChanged: (value) {
  //         logic.hadRead.value=value!;
  //       }),
  //       TextButton(
  //         onPressed: () {
