...
class MySearchChatHistoryPage extends StatelessWidget {
  final logic = Get.find<SearchChatHistoryLogic>();

  MySearchChatHistoryPage({super.key});
  ...
  Widget _buildKkxItemView(Message message) => GestureDetector(
  ...
  Widget get _resultView => SmartRefresher(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (_, index) =>
              _buildKkxItemView(logic.messageList.elementAt(index)),
        ),
      );
