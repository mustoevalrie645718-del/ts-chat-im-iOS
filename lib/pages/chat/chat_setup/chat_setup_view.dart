...
class ChatNewSetupPage extends StatelessWidget {
  final logic = Get.find<ChatSetupLogic>();

  ChatNewSetupPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: TitleBar.back(title: StrRes.settings),
      backgroundColor: Styles.c_F8F9FA,
      body: SingleChildScrollView(
        child: Obx(() => Column(
              children: [
                _buildLiveBaseInfoView(),
                _buildLodsContentSearchView(),
                17.verticalSpace,
                _buildItemView(
  ...
  Widget _buildLiveBaseInfoView() => Container(
  ...
  Widget _buildLodsContentSearchView() {
