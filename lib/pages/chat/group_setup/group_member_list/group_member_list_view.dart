...
class GroupMemberErListPage extends StatelessWidget {
              ...
              Flexible(
                child: SmartRefresher(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, index) => Obx(() => _buildYunItemView(logic.memberList[index])),
                  ),
                ),
              ),
  ...
  Widget _buildYunItemView(GroupMembersInfo membersInfo) => logic.hiddenMember(membersInfo)
      ? const SizedBox()
      : GestureDetector(
          behavior: HitTestBehavior.translucent,
  ...
  Widget _buildCheckedConfirmView() => Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Button(
              height: 40.h,
              enabled: logic.checkedList.isNotEmpty,
...
class SelectedMemberViewListView extends StatelessWidget {
  SelectedMemberViewListView({Key? key}) : super(key: key);
  final logic = Get.find<GroupMemberListLogic>(tag: (Get.arguments['opType'] as GroupMemberOpType).name);
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemBuilder: (_, index) => _buildBerItemView(logic.checkedList[index]),
                ),
              ),
            ],
          )),
  ...
  Widget _buildBerItemView(GroupMembersInfo membersInfo) => Container(
        height: 64.h,
        padding: EdgeInsets.symmetric(horizontal: 16.w),
        color: Styles.c_FFFFFF,
        child: Row(
