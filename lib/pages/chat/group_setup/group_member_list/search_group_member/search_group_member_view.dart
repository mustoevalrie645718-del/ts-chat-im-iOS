...
class MySearchGroupMemberPage extends StatelessWidget {
  final logic = Get.find<SearchGroupMemberLogic>();

  MySearchGroupMemberPage({super.key});
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    if (logic.hiddenMembers(info)) {
                      ...
                      return _buildListItemView(info);
                    }
                  },
                ),
              )),
  ...
  Widget _buildListItemView(GroupMembersInfo membersInfo) => GestureDetector(
