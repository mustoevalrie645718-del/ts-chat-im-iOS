...
class GroupSetupErPage extends StatelessWidget {
  final logic = Get.find<GroupSetupLogic>();

  GroupSetupErPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() => SingleChildScrollView(
            child: Column(
              children: [
                if (logic.isJoinedGroup.value) _buildKkxBaseInfoView(),
                if (logic.isJoinedGroup.value) _buildMyMemberView(),
                _buildCloContentdSearchView(),
                _buildItemView(
                  text: StrRes.groupAc,
                  showRightArrow: true,
                  isTopRadius: true,
  ...
  Widget _buildKkxBaseInfoView() => Container(
        height: 80.h,
                ...
                children: [
                  GestureDetector(
                    ...
                    onTap: logic.isOwnerOrAdmin
                        ? () => logic.modifyGroupName(logic.conversationInfo.value.faceURL)
                        : null,
                    child: Row(
                      children: [
                        Flexible(
  ...
  Widget _buildMyMemberView() => Container(
        decoration: BoxDecoration(
          color: Styles.c_FFFFFF,
          borderRadius: BorderRadius.circular(6.r),
        ),
  ...
  Widget _buildCloContentdSearchView() {
