...
class SearchFriendShipPage extends StatelessWidget {
  final logic = Get.find<SearchFriendLogic>();

  SearchFriendShipPage({super.key});
      ...
      child: Scaffold(
        ...
        body: Obx(() => logic.isSearchNotResult
            ...
            : ListView.builder(
                ...
                itemBuilder: (_, index) =>
                    _buildFriedItemView(logic.resultList[index]),
              )),
      ),
    );
  }

  Widget _buildFriedItemView(ISUserInfo info) => Ink(
        height: 64.h,
