...
class MyAddContactsBySearchPage extends StatelessWidget {
  final logic = Get.find<AddContactsBySearchLogic>();

  MyAddContactsBySearchPage({super.key});
          ...
          Obx(() => Expanded(
                child: logic.isSearchUser
                    ? (logic.isNotFoundUser
                        ? _buildNotFoundDataView()
                        : _buildNewUserListView())
  ...
  Widget _buildNewUserListView() => SmartRefresher(
  ...
  Widget _buildNotFoundDataView() => Container(
