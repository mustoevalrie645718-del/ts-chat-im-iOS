...
class ProcessFriendRequestsRePage extends StatelessWidget {
  final logic = Get.find<ProcessFriendRequestsLogic>();

  ProcessFriendRequestsRePage({super.key});
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Flexible(child: _buildRejectButtonView()),
                12.horizontalSpace,
                Flexible(
                  child: Button(
                    text: StrRes.accept,
  ...
  Widget _buildRejectButtonView() => Material(
        child: Ink(
          height: 44.h,
          decoration: BoxDecoration(
            color: Styles.c_FFFFFF,
