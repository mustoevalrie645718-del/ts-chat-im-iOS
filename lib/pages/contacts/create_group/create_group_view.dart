...
class CreateFeiGroupPage extends StatelessWidget {
  final logic = Get.find<CreateGroupLogic>();

  CreateFeiGroupPage({super.key});
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: SizedBox(
            ...
            child: Column(
              children: [
                _buildGroupBaseInfoMisView(),
                _buildCudGroupMemberView(),
                const Spacer(),
                Container(
  ...
  Widget _buildGroupBaseInfoMisView() => Container(
  ...
  Widget _buildCudGroupMemberView() => Obx(() => Container(
        decoration: BoxDecoration(
          color: Styles.c_FFFFFF,
          borderRadius: BorderRadius.circular(6.r),
        ),
