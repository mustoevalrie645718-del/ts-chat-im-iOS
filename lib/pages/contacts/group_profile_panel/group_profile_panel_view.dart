...
class GroupProfilePanelNewPage extends StatelessWidget {
  final logic = Get.find<GroupProfilePanelLogic>();

  GroupProfilePanelNewPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() => Column(
            children: [
              _buildBaseInfoView(),
              if (logic.members.isNotEmpty) _buildGroupLisMemberList(),
              Container(
                height: 56.h,
  ...
  Widget _buildGroupLisMemberList() => Container(
        color: Styles.c_FFFFFF,
        padding: EdgeInsets.symmetric(horizontal: 16.w, vertical: 12.h),
        margin: EdgeInsets.only(bottom: 10.h),
        child: Column(
