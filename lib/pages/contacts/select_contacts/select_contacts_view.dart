...
class YourSelectContactsPage extends StatelessWidget {
  final logic = Get.find<SelectContactsLogic>();

  YourSelectContactsPage({super.key});
...
class CheckedViewConfirmView extends StatelessWidget {
  CheckedViewConfirmView({Key? key}) : super(key: key);
  final logic = Get.find<SelectContactsLogic>();
