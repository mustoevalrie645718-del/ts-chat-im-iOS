...
class SelectContactsCLoudFromSearchFriendsPage extends StatelessWidget {
  final logic = Get.find<SelectContactsFromSearchFriendsLogic>();
  final selectContactsLogic = Get.find<SelectContactsLogic>();

  SelectContactsCLoudFromSearchFriendsPage({super.key});
      ...
      child: Scaffold(
        ...
        body: Obx(() => logic.isSearchNotResult
            ...
            : ListView.builder(
                ...
                itemBuilder: (_, index) =>
                    _buildKkxItemView(logic.resultList[index]),
              )),
      ),
    );
  }

  Widget _buildKkxItemView(ISUserInfo info) {
