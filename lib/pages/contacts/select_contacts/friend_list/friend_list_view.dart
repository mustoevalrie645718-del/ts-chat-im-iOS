...
class MySelectContactsFromFriendsPage extends StatelessWidget {
          ...
          Flexible(
            child: Obx(
              () => WrapAzListView<ISUserInfo>(
                ...
                itemBuilder: (_, data, index) => _buildItemLlView(data),
              ),
            ),
          ),
  ...
  Widget _buildItemLlView(ISUserInfo info) {
