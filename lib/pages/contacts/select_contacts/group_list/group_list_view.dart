...
class WindySelectContactsFromGroupPage extends StatelessWidget {
  final logic = Get.find<SelectContactsFromGroupLogic>();
  final selectContactsLogic = Get.find<SelectContactsLogic>();

  WindySelectContactsFromGroupPage({super.key});
        ...
        children: [
          ...
          Expanded(
              child: Obx(() => ListView.builder(
                    ...
                    itemBuilder: (_, index) =>
                        _builddItemView(logic.allList[index]),
                  ))),
  ...
  Widget _builddItemView(GroupInfo info) {
