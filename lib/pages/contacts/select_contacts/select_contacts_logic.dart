...
class SelectContactsLogic extends GetxController implements OrganizationMultiSelBridge {
  ...
  _queryConversationList() async {
    if (!hiddenConversations) {
      ...
      final filteredCons = results
          .where((con) => con != null && (!con.isSingleChat || !friendCache.isBlacklist(con.userID!)))
          .cast<ConversationInfo>()
          .toList();
  ...
  @override
  Widget get checkedConfirmView => isMultiModel ? CheckedViewConfirmView() : const SizedBox();
}
