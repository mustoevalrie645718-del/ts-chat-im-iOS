...
class PersonalInfoIngPage extends StatelessWidget {
  final logic = Get.find<PersonalInfoLogic>();

  PersonalInfoIngPage({super.key});
  ...
  Widget _buildCornerBgerView({required List<Widget> children}) => Container(
