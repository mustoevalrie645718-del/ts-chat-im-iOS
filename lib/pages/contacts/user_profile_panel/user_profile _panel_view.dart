...
class UserNewProfilePanelPage extends StatelessWidget {
  final logic = Get.find<UserProfilePanelLogic>(tag: GetTags.userProfile);

  UserNewProfilePanelPage({super.key});
          ...
          child: Stack(
            children: [
              SingleChildScrollView(
                child: Column(
                  children: [
                    _buildYunBaseInfoView(),
                    if (logic.isGroupMemberPage) _buildFengEnterGroupMethodView(),
              ...
              if ((logic.isFriendship || logic.allowSendMsgNotFriend) && !logic.isMyself) _buildGongButtonGroup(),
            ],
          ),
        ),
      ),
  ...
  Widget _buildYunBaseInfoView() => Container(
  ...
  Widget _buildFengEnterGroupMethodView() {
          ...
          if (logic.joinGroupTime.value > 0)
            _buildBaTabRowView(
              ...
              value: DateUtil.formatDateMs(
                ...
                format: Get.locale?.languageCode.toLowerCase() == 'zh' ? DateFormats.zh_y_mo_d : DateFormats.y_mo_d,
              ),
            ),
  ...
  Widget _buildGongButtonGroup() => Positioned(
        bottom: 0.h,
        width: 1.sw,
        child: ClipRRect(
