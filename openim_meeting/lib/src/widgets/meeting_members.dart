...
class MeetingMembersSheetView extends StatefulWidget {
  ...
  final bool isHost;
  final void Function(String userID, bool value)? onTapMic;
  final void Function(String userID, bool value)? onTapCamera;
...
class _MeetingMembersSheetViewState extends State<MeetingMembersSheetView> {
  ...
  _onTapCamera(String userID, bool value) {
    widget.onTapCamera?.call(userID, value);
    MeetingRepository().setPersonalSetting(
  ...
  _onTapMic(String userID, bool value) {
    widget.onTapMic?.call(userID, value);
    MeetingRepository().setPersonalSetting(
      _meetingInfo!.meetingID,
      userID,
