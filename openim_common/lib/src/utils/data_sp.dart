...
class DataSp {
  ...
  static const _groupApplicationTime = "%s_groupApplicationTime";
  static const _friendApplication = "%s_friendApplication";
  static const _friendApplicationTime = "%s_friendApplicationTime";
  ...
  static Future<bool>? putHaveReadUnHandleGroupApplicationTime() {
    return SpUtil().putInt(getKey(_groupApplicationTime), DateTime.now().millisecondsSinceEpoch);
  }
  ...
  static Future<bool>? putHaveReadUnHandleFriendApplicationTime() {
    return SpUtil().putInt(getKey(_friendApplicationTime), DateTime.now().millisecondsSinceEpoch);
  }
  ...
  static int? getHaveReadUnHandleGroupApplicationTime() {
    final time = SpUtil().getInt(getKey(_groupApplicationTime));
  ...
  static int? getHaveReadUnHandleFriendApplicationTime() {
    final time = SpUtil().getInt(getKey(_friendApplicationTime));
    if (time == null) return null;
  ...
  static Future<bool>? putThemeMode(int mode) {
    return SpUtil().putInt(_themeMode, mode);
  }

  static int getThemeMode() {
    return SpUtil().getInt(_themeMode) ?? 0;
  }
}
