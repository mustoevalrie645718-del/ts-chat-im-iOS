...
class ChatItemContainer extends StatelessWidget {
  ...
  final Widget? editHintView;
  final CustomPopupMenuController? popupMenuController;
  final Stream<MsgStreamEv<int>>? sendStatusStream;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: isPrivateChat ? null : (isMultiSelModel ? () => onRadioChanged?.call(!isChecked) : null),
      child: IgnorePointer(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  if (!isMultiSelModel && isSending) ChatDelayedStatusView(isSending: isSending),
                  4.horizontalSpace,
