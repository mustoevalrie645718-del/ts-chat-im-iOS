...
class ChatToolBox extends StatelessWidget {
  ...
  final VoidCallback? onTapFavoriteMessage;
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      if (onTapFavoriteMessage != null)
        ToolboxItemInfo(
          text: StrRes.toolboxFavoriteMessage,
          icon: ImageRes.toolboxFavoriteMessage,
          onTap: onTapFavoriteMessage,
        )
    ];
