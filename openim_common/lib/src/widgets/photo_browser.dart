  ...
  void _preloadImage(int index) {
    ...
    if (0 <= index && index < widget.sources.length) {
      ...
      if (s.file != null && s.file!.existsSync()) {
        ...
        final url = s.isVideo ? s.thumbnail : (s.thumbnail.isEmpty ? s.url! : s.thumbnail);
...
class _VideoPlayerViewState extends State<VideoPlayerView> {
  ...
  bool _coverAnimationCompleted = false;

  @override
  void initState() {
    super.initState();
    Logger.print('VideoPlayerView initState:[${widget.file}], [${widget.path}], [${widget.url}]',
    ...
    } else if (widget.path?.isNotEmpty == true && File(widget.path!).existsSync()) {
