...
class StrRes {
  ...
  static String get githubLogin => 'githubLogin'.tr;
  static String get thirdPartyLogin => 'thirdPartyLogin'.tr;
  ...
  static String get plsEnterRightPhone => 'plsEnterRightX'.trArgs([phoneNumber]);
  ...
  static String get plsEnterYourNickname => 'plsEnterYourX'.trArgs([nickname]);
  ...
  static String get groupAggregatedMessage => 'groupAggregatedMessage'.tr;

  static String get privateAggregatedMessage => 'privateAggregatedMessage'.tr;
  ...
  static String get stream => 'stream'.tr;

  static String get markdown => 'markdown'.tr;

  static String get chatRecord => 'chatRecord'.tr;

  static String get groupChat => 'groupChat'.tr;

  static String get aAndB => 'aAndB'.tr;

  static String get xChatRecord => 'xChatRecord'.tr;
  ...
  static String get isAlreadyLatestVersion => 'isAlreadyLatestVersion'.tr;
  ...
  static String get toolboxFavoriteMessage => 'toolboxFavoriteMessage'.tr;
  ...
  static String get edited => 'edited'.tr;
  ...
  static String get collect => 'collect'.tr;

  static String get myCollection => 'myCollection'.tr;
  ...
  static String get man => 'male'.tr;

  static String get woman => 'female'.tr;
  ...
  static String get otherBeAddedBlacklist => 'otherBeAddedBlacklist'.tr;
  ...
  static String get plsEnterRightEmail => 'plsEnterRightX'.trArgs([email]);

  static String get emailFormatError => 'emailFormatError'.tr;

  static String get plsEnterRightAccount => 'plsEnterRightX'.trArgs([account]);

  static String get groupName => 'groupName'.tr;

  static String get groupAcPermissionTips => 'groupAcPermissionTips'.tr;

  static String get noGroupAcYet => 'noGroupAcYet'.tr;
  ...
  static String get notFoundChatHistory => 'searchNotFound'.tr;
  ...
  static String get userBusyVideoCallHint => 'userBusyVideoCallHint'.tr;
  static String get callAgainLater => 'callAgainLater'.tr;
  ...
  static String get joinFailure => 'joinFailure'.tr;
  ...
  static String get enterMeeting => 'joinMeeting'.tr;
  ...
  static String get quoteContentBeDeleted => 'quoteContentBeDeleted'.tr;
  ...
  static String get previewFontSizeHint => 'previewFontSizeHint'.tr;
  static String get processingHint => 'processingHint'.tr;
  static String get pinnedMessage => 'pinnedMessage'.tr;
  static String get unpinnedMessage => 'unpinnedMessage'.tr;
  static String get favoriteSuccess => 'favoriteSuccess'.tr;
  static String get deleteMessageHint => 'deleteMessageHint'.tr;
  static String get deleteMessagesHint => 'deleteMessagesHint'.tr;
  static String get approveToOthers => 'approveToOthers'.tr;
  static String get approveToOthersMultiple => 'approveToOthersMultiple'.tr;
  static String get removeMemberHint => 'removeMemberHint'.tr;
  static String get removeMembersHint => 'removeMembersHint'.tr;
  static String get deleteMemberMessageHint => 'deleteMemberMessageHint'.tr;
  static String get deleteMembersMessageHint => 'deleteMembersMessageHint'.tr;
  static String get deleteAccount => 'deleteAccount'.tr;
  static String get confirmDeleteAccount => 'confirmDeleteAccount'.tr;
  static String get confirmDeleteAccountHint => 'confirmDeleteAccountHint'.tr;
  static String get locateToOriginal => 'locateToOriginal'.tr;
  static String get groupApply => 'groupApply'.tr;
  static String get groupApplyHint => 'groupApplyHint'.tr;
  static String get friendApply => 'friendApply'.tr;
  static String get friendApplyHint => 'friendApplyHint'.tr;
  static String get xDeleted => 'xDeleted'.tr;
  static String get robotList => 'robotList'.tr;
  static String get noRobot => 'noRobot'.tr;
  static String get revokeMessageHint => 'revokeMessageHint'.tr;
  static String get otherLogin => 'otherLogin'.tr;
  static String get collectRepeat => 'collectRepeat'.tr;
  static String get collectFailed => 'collectFailed'.tr;
  static String get collectNone => 'collectNone'.tr;
  static String get recordRemindHint => 'recordRemindHint'.tr;
  static String get noDuplicatesAllowed => 'noDuplicatesAllowed'.tr;
  static String get emojiExists => 'emojiExists'.tr;
  static String get connectionDisconnected => 'connectionDisconnected'.tr;
  static String get requestToTurnOnCamera => 'requestToTurnOnCamera'.tr;
  static String get requestToUnmuteMic => 'requestToUnmuteMic'.tr;
  static String get open => 'open'.tr;
  static String get maxSelectedItems => 'maxSelectedItems'.tr;
}
