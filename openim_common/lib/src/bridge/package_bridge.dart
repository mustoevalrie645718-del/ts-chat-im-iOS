...
class GetTags {
  ...
  static final List<String> _chatPreviewTags = <String>[];
  ...
  static void createChatPreviewTag() {
    _chatPreviewTags.add('_preview_${DateTime.now().millisecondsSinceEpoch}');
  }
  ...
  static void destroyChatPreviewTag() {
    _chatPreviewTags.removeLast();
  }
  ...
  static String? get chatPreview => _chatPreviewTags.isNotEmpty ? _chatPreviewTags.last : null;
  ...
  static String? get userProfile => _userProfileTags.isNotEmpty ? _userProfileTags.last : null;
}
