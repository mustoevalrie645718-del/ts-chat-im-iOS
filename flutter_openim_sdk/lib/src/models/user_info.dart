...
class DeleteFriendRequest {
  ...
  DeleteFriendRequest({required this.fromUserID, required this.toUserID});

  DeleteFriendRequest.fromJson(Map<String, dynamic> json)
      : fromUserID = json['fromUserID'],
        toUserID = json['toUserID'];
  ...
  @override
  String toString() {
    return 'DeleteFriendRequest{fromUserID: $fromUserID, toUserID: $toUserID}';
  }
}
