...
//数据
class FgCubePage extends StatefulWidget {

  @override
  State<FgCubePage> createState() => _FgCubePageState();
}

class _FgCubePageState extends State<FgCubePage>
